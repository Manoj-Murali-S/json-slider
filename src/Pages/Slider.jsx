                ...
                <Dialog.Panel className="pointer-events-auto relative w-screen max-w-md">
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      ...
                      <p className='font-normal p-2.5 text-sm'>To save your segment, you need to add the schemas to build the querry.</p>
                      ...
                      <button
                        ...
                        className="mt-4 px-4 py-2 text-sm font-semibold decoration-cyan-500 underline text-cyan-500 rounded-md hover:text-cyan-600 focus:outline-none focus:decoration-cyan-600 flex gap-2 items-center"
                      >
